    ...
    <v-row justify="center">
      ...
      >
        <v-img
          ...
          height="250px"
          :src="require('@/assets/images/perso/gmailclone.png')"
        >
        </v-img>
        <v-card-title color="primary">Le Gmail de Chuck Norris</v-card-title>
      ...
      >
        <v-img
          class="white--text align-end"
          height="250px"
          :src="require('@/assets/images/perso/slackclone.png')"
        >
        </v-img>
        <v-card-title color="primary">Un clone de Slack</v-card-title>
